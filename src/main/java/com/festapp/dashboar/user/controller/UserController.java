...
package com.festapp.dashboar.user.controller;
...
import com.festapp.dashboar.user.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<Long>> getUserCountByRole(
        ...
        Long count = userService.getUserCountByRole(com.festapp.dashboar.user.entity.User.Role.valueOf(role.toUpperCase()));
