...
public class DashboardWidgetServiceTest {
    ...
    void testUpdateLayoutsSuccess() {
        ...
        var layoutDto = com.festapp.dashboar.dashboard.widget.dto.WidgetLayoutUpdateDto.builder()
                .layouts(java.util.Arrays.asList(
                        com.festapp.dashboar.dashboard.widget.dto.WidgetLayoutUpdateDto.LayoutItem.builder()
